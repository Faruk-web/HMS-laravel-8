<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        @if (Auth::guard('super_admin')->check() || Auth::guard('admin')->check())
            ...
            <li>
                <a href="{{ route('add.permissions') }}" class="waves-effect">
        ...
        <li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{ route('notice.add') }}">Add Notioce</a></li>
                </ul>
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="{{ route('notice.view') }}">Notice List</a></li>
                </ul>
            </li>
        ...
        @elseif (Auth::guard('doctor')->check())
            ...
            {{-- role permission for employees --}}
        @else
              @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Prescription']['list'])
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="fa ti-book"></i>
                        <span>Prescription</span>
              ...
              @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Schedule']['list'])
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="fa fa ti-calendar"></i>
                        <span>Schedule</span>
            ...
            {{-- For Blood Bank --}}
            @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Blood_Bank']['list'])
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="fas fa-tint"></i>
                    <span>Blood Bank</span>
            ...
            @endisset
            {{-- for patient Bed --}}
            @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Manage_Bed']['list'])
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="fa fa-bed"></i>
                    <span>Manage Bed</span>
            ...
            @endisset
            @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Manage_Diagnosis']['list'])
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="fas fa-diagnoses"></i>
                    <span>Manage Diagnosis</span>
            ...
            @endisset
            @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Manage_Medicine']['list'])
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="fas fa-capsules"></i>
                    <span>Manage Medicine</span>
            ...
            @endisset
            @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Manage_Record']['list'])
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="fas fa-laptop-medical"></i>
                    <span>Manage Record</span>
            ...
            @endisset
            @isset(Auth::guard('employee')->user()->role->rolePermission['permission']['Insurance']['list'])
            <li>
                <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <i class="fas fa-laptop-medical"></i>
                    <span>Insurance</span>
