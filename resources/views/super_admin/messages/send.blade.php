        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title text-center">All Sent Messages
                        <div class="text-end">
                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#AddMessageModal">New Message</button>
                            <a href="{{ route('message.inbox.view') }}"><button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="">Inbox</button></a>
                        </div>
                    </h4>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <option value="super admin">super admin</option>
                                                     ...
                                                     <option value="admin12">admin12</option>
                                                    </select>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <dl class="dl-horizontal">
                                                <dt>Sender Name : </dt>
                                                <dd><span id="sender_name"></span></dd>

                                                <dt>Send To : </dt>
                                                <dd><span id="sender_to"></span></dd>

                                                <dt>Date : </dt>
                                                <dd><span id="date"></span></dd>

                                                <dt>Subject : </dt>
                                                <dd><span id="subject"></span></dd>

                                                <dt>Message : </dt>
                                                <dd><span id="message"></span></dd>
                                            </dl>
                                        </div>
                                    </div>
                                    ...
                                    aria-describedby="datatable-buttons_info">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th rowspan="1" colspan="1" style="width: 120px;">Send To</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="dtr-control sorting_1" tabindex="0">{{ $message->send_to }}</td>
