                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center">Time Schedule
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" id="addModal">
                                Add Time Slot
                            </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="">
                                        ...
                                        <div class="modal-footer">
                                            <button type="reset" class="but button1 ">Reset</button>
                                            <button type="submit"
                                                class="btn btn-rounded btn-info update_schedule_slot" data-dismiss="modal">update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="datatable-buttons"
                                        class="dataShow table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline text-center align-middle"
                                            ...
                                            @foreach ($diagnosiscats as $diagnosiscat)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a value="{{ $diagnosiscat->id }}"
                                                            class="btn btn-danger btn-sm del_btn" id="delete"><i
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 400) {
                            $('#error_slot_name').empty();
                            $('#error_slot_time').empty();
                            $('#error_status').empty();
                            ...
                            $('.add_timeslot').text('Save');
                            $('.dataShow tbody').prepend(
                                `<tr>
                                   <td> ${response.schedule.slot_name} </td>
                                   <td> ${response.schedule.slot_time} </td>
                                   <td> ${response.schedule.status} </td>
                                   <td>
                                        <button type="button" value="${response.schedule.id}"
                                            class="btn btn-success editBtn btn-sm">
                                            <i class="fa fa-pencil-alt"></i></button>
                                        <a href=""
                                            class="btn btn-danger btn-sm del_btn" value="${response.schedule.id}" id="delete"><i
                                                class="fa fa-trash"></i></a>
                                    </td>
                                </tr>`
                            );
