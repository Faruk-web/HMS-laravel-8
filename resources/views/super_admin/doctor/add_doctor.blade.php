...
<div class="row my-5">
    <div class="col-1"></div>
        <div class="col-10">
            <div class="card">
                <div class="card-body">
                    <div class="card d-flex" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 1px 2px 0px !important; ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="doc_dept" class="form-control">
                                            ...
                                            @foreach ($doctorDepts as $doctorDept)
                                                <option value="{{ $doctorDept->id }}">{{ $doctorDept->name }}
                                                </option>
                                            @endforeach
                                        </select>
            ...
            axios.post('/doctor/store', formData)
                .then(response => {
                    ...
                    if (error.response.status == 422) {
                        $('#error_name').text(error.response.data.errors.name);
                        $('#error_email').text(error.response.data.errors.email);
                        $('#error_password').text(error.response.data.errors.password);
                        ...
                        $('#error_gender').text(error.response.data.errors.sex);
                        $('#error_address1').text(error.response.data.errors.address1);
    ...
    <script>
        $(document).ready(function() {
            ...
            function dynamic_field(number) {
                html = '<tr>';
                html += '<td><input type="text" name="language_name[]" id="language_name" class="form-control" /></td>';
                html += '<td><input type="number" name="rating[]" id="rating" class="form-control" /></td>';
                if (number > 1) {
                    html +=
