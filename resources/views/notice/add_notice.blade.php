                            ...
                            <div class="row  my-5 mx-5">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Enter your birth date"id="startDate"
                                            name="startDate">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Enter your birth date"id="endDate"
                                            name="endDate">
    ...
    <script>
        ...
        $(document).ready(function(){
            $("#AddNoticeFORM").on('submit', function(event) {
                ...
                axios.post('/notice/store/', formData)
                    .then(response => {
